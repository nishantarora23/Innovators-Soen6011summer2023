...
CREATE TABLE `jobs` (
  ...
  `STATUS`` varchar(255) COLLATE utf8mb4 DEFAULT `active`,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

LOCK TABLES `jobs` WRITE;
/*!40000 ALTER TABLE `jobs` DISABLE KEYS */;
INSERT INTO `jobs` VALUES (1,'Software Engineer','USD 80,000 - 100,000','Develop and maintain software applications','Bachelor\'s degree in Computer Science or related field','New York','We are seeking a skilled Software Engineer to join our team...','2023-08-31','Full-time','ABC Technologies'),(2,'Marketing Specialist','USD 60,000 - 75,000','Plan and execute marketing campaigns','Bachelor\'s degree in Marketing or equivalent','San Francisco','We are looking for a creative Marketing Specialist...','2023-09-15','Contract','XYZ Marketing Agency'),(3,'Data Analyst','USD 70,000 - 90,000','Analyze and interpret data for insights','Bachelor\'s degree in Statistics or related field','Chicago','Join our Data Analytics team as a Data Analyst...','2023-08-25','Part-time','Data Insights Inc.'),(4,'Sales Representative','USD 50,000 - 65,000','Promote and sell company products','High school diploma required; Sales experience preferred','Los Angeles','We are hiring Sales Representatives to expand our market...','2023-09-10','Full-time','Sales Pro Solutions'),(5,'Graphic Designer','USD 55,000 - 70,000','Create visually appealing designs for clients','Bachelor\'s degree in Graphic Design or related field','London','Looking for a talented Graphic Designer to join our creative team...','2023-08-20','Full-time','Designs R Us');
